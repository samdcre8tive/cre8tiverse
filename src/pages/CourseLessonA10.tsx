...
const CourseLessonA10 = () => {
  ...
  const timecodes = [
    ...
    { time: '0:35', title: 'Where to Download Pictures from (Using Pexels.com)' },
    { time: '3:53', title: 'Downloading Music and Sound Effects (Pixabay)' },
    { time: '4:09', title: 'How to Download the Subscribe Button for YouTube' },
    { time: '4:45', title: 'Where to Download Icons from (Iconfinder.com)' },
    { time: '5:44', title: 'Where to Download Icons from (Icon8.com)' },
    { time: '6:10', title: 'Where to Download Free Assets or Color Palettes from (Color.adobe.com)' }
  ];

  const learningOutcomes = [
    'Discover the best sources for free design resources',
    'Download high-quality pictures from Pexels',
    'Find free music and sound effects for projects',
    'Access professional icons from multiple sources',
    'Use Adobe Color for stunning color palettes',
    'Build a resource library for future projects'
  ];
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              <div className="relative">
                <div className="aspect-video bg-black">
                  <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/HViyIln8PUw?si=JoLI0YLLQM-bv77u" 
                    title="Where to Download Free Pictures, Assets, Color Palettes for Adobe Illustrator | Cre8tiverse" 
                    frameBorder="0" 
              ...
              <div className="p-6 border-b border-gray-200">
                <CourseNavigation currentLessonId="a10" />
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  <div className="mb-4 md:mb-0">
                    <h1 className="text-2xl md:text-3xl font-bold text-primary mb-2">
                      Where to Download Free Pictures, Assets, Color Palettes for Adobe Illustrator
                    </h1>
                    <p className="text-lg text-gray-600">
                      Discover the best free resources to enhance your Illustrator designs.
                    </p>
                  </div>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed">
                  In this lesson, you'll discover where to find free pictures, assets, color palettes, and videos to enhance 
                  your Adobe Illustrator designs. We'll explore the best resources for free design elements and show you how 
                  to use them effectively in your creative projects. Whether you're a beginner or a seasoned designer, these 
                  free resources will save you time and elevate your design work!
                </p>
              </div>
            </motion.div>
          ...
          {/* Sidebar Navigation */}
          <CourseNavigation currentLessonId="a10" className="lg:col-span-1" />
        </div>
      </div>
    </div>
  );
...
export default CourseLessonA10;