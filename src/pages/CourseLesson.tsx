...
const CourseLesson = () => {
  ...
  const isCompleted = isLessonCompleted('a1');
  ...
  const timecodes = [
    ...
    { time: '01:04', title: 'What is Adobe Illustrator?' },
    { time: '02:19', title: 'What is Adobe Illustrator used for?' },
    { time: '02:50', title: 'Difference Between Raster and Vector Graphics' },
    { time: '10:58', title: 'Setting Up a New Document' },
    { time: '13:28', title: 'What is Bleed?' },
    { time: '15:32', title: 'CMYK vs RGB Colour Modes' }
  ];

  const learningOutcomes = [
    'Understand the role and purpose of Adobe Illustrator',
    'Differentiate between vector and raster graphics',
    'Set up a new Illustrator document from scratch',
    'Define bleed and colour modes (CMYK vs RGB)',
    'Begin your first creative project confidently'
  ];

  const handleMarkComplete = () => {
    if (isCompleted) {
      markLessonIncomplete('a1');
    } else {
      markLessonComplete('a1');
    }
  };
  ...
  const breadcrumbItems = [
    ...
    { label: 'What is Adobe Illustrator?' }
  ];
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              ...
              <div className="relative">
                <div className="aspect-video bg-black">
                  <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/cg3Vp4kPGEk?si=example" 
                    title="What is Adobe Illustrator? | Vector vs Raster & Starting Your First Design – Cre8tiverse" 
                    frameBorder="0" 
              ...
              <div className="p-6 border-b border-gray-200">
                <CourseNavigation currentLessonId="a1" />
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  <div className="mb-4 md:mb-0">
                    <h1 className="text-2xl md:text-3xl font-bold text-primary mb-2">
                      What is Adobe Illustrator? | Vector vs Raster & Starting Your First Design
                    </h1>
                    <p className="text-lg text-gray-600">
                      Understand Adobe Illustrator and set up your first design.
                    </p>
                  </div>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed">
                  In this introductory lesson, you'll explore what Adobe Illustrator is, how it's different from 
                  raster-based tools like Photoshop, and its real-world applications in design and branding. 
                  You'll also learn how to create a new Illustrator document, understand key terms like "bleed," 
                  and correctly set up your project using RGB or CMYK colour modes.
                </p>
              </div>
            </motion.div>
          ...
          {/* Sidebar Navigation */}
          <CourseNavigation currentLessonId="a1" className="lg:col-span-1" />
        </div>
      </div>
    </div>
  );
