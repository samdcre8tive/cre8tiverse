...
const CourseIntro = () => {
  ...
  const isCompleted = isLessonCompleted('intro');
  ...
  const timecodes = [
    { time: '00:00', title: 'Intro to the Illustrator Course' },
    { time: '00:31', title: 'Section 1: Illustrator Essentials Overview' },
    { time: '01:29', title: 'Bonus Tips for Getting Started' },
    { time: '01:43', title: 'Section 2: Creative Practical in Adobe Illustrator' }
  ];

  const learningOutcomes = [
    'Get a complete overview of the course structure',
    'Understand what you\'ll learn in each section',
    'Access all course resources and files',
    'Connect with the Cre8tiverse community',
    'Set expectations for your learning journey'
  ];

  const handleMarkComplete = () => {
    if (isCompleted) {
      markLessonIncomplete('intro');
    } else {
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              ...
              <div className="relative">
                <div className="aspect-video bg-black">
                  <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/BOD8cLbWhR4?si=example" 
                    title="Introduction to Adobe Illustrator – Course Overview and What You'll Learn | Cre8tiverse" 
                    frameBorder="0" 
              ...
              <div className="p-6 border-b border-gray-200">
                <CourseNavigation currentLessonId="intro" />
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  <div className="mb-4 md:mb-0">
                    <h1 className="text-2xl md:text-3xl font-bold text-primary mb-2">
                      Introduction to Adobe Illustrator – Course Overview and What You'll Learn
                    </h1>
                    <p className="text-lg text-gray-600">
                      Welcome to the Adobe Illustrator Course by Cre8tiverse
                    </p>
                  </div>
            ...
            >
              <h2 className="text-2xl md:text-3xl font-bold text-primary mb-6">Course Overview</h2>
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed">
                  Welcome to the Adobe Illustrator Course by Cre8tiverse! In this introduction video, you'll get a complete 
                  overview of what the course covers — from Illustrator essentials to creative practicals and bonus tips. 
                  If you're ready to master Adobe Illustrator for design, branding, and content creation, you're in the right place!
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex flex-col md:flex-row items-center md:justify-between">
                <div className="mb-6 md:mb-0 text-center md:text-left">
                  <h2 className="text-2xl md:text-3xl font-bold mb-2">Course Resources</h2>
                  <p className="text-white/90 mb-4">
                    Download all files for this course
                  </p>
          ...
          {/* Sidebar Navigation */}
          <CourseNavigation currentLessonId="intro" className="lg:col-span-1" />
        </div>
      </div>
    </div>
  );
