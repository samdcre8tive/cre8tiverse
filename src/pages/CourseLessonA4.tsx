...
const CourseLessonA4 = () => {
  ...
  const isCompleted = isLessonCompleted('a4');
  ...
  const timecodes = [
    ...
    { time: '0:31', title: 'Drawing Basic Shapes in Adobe Illustrator' },
    { time: '1:04', title: 'Using the Direct Selection Tool' },
    { time: '1:24', title: 'Drawing Ellipses and Perfect Circles' },
    { time: '2:02', title: 'Creating Polygons in Illustrator' },
    { time: '2:48', title: 'The Star Tool Explained' },
    { time: '2:58', title: 'Drawing with the Line Segment Tool' },
    { time: '4:20', title: 'Introduction to the Pathfinder Tool' },
    { time: '6:48', title: 'Using the Shape Builder Tool in Illustrator' },
    { time: '8:30', title: 'Align Tool: Aligning Objects Precisely' }
  ];

  const learningOutcomes = [
    'Create and work with basic shapes in Illustrator',
    'Master the powerful Pathfinder Tool for shape operations',
    'Use the Shape Builder Tool for intuitive design',
    'Arrange layouts using Align tools for precision',
    'Combine and subtract shapes for complex designs',
    'Apply professional alignment techniques'
  ];

  const handleMarkComplete = () => {
    if (isCompleted) {
      markLessonIncomplete('a4');
    } else {
      markLessonComplete('a4');
    }
  };
  ...
  const breadcrumbItems = [
    ...
    { label: 'Drawing Shapes & Pathfinder' }
  ];
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              <div className="relative">
                <div className="aspect-video bg-black">
                  <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/XVslGJPWiM8?si=CKI97BznX6L9gnTb" 
                    title="Drawing Shapes & Using Pathfinder in Adobe Illustrator | Layout & Align Tools – Cre8tiverse" 
                    frameBorder="0" 
              ...
              <div className="p-6 border-b border-gray-200">
                <CourseNavigation currentLessonId="a4" />
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  <div className="mb-4 md:mb-0">
                    <h1 className="text-2xl md:text-3xl font-bold text-primary mb-2">
                      Drawing Shapes & Using Pathfinder in Adobe Illustrator | Layout & Align Tools
                    </h1>
                    <p className="text-lg text-gray-600">
                      Master shape creation and advanced layout tools for precise designs.
                    </p>
                  </div>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed">
                  In this lesson, you'll learn how to create and work with basic shapes, use the powerful Pathfinder Tool 
                  to combine or subtract shapes, and arrange your layout using the Align tools for precise designs. 
                  If you're looking to design smarter and faster in Illustrator, this video is a must-watch!
                </p>
              </div>
            </motion.div>
          ...
          {/* Sidebar Navigation */}
          <CourseNavigation currentLessonId="a4" className="lg:col-span-1" />
        </div>
      </div>
    </div>
  );
