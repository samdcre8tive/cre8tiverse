...
const CourseLessonA6 = () => {
  ...
  const isCompleted = isLessonCompleted('a6');
  ...
  const timecodes = [
    ...
    { time: '0:30', title: 'How to Group' },
    { time: '1:55', title: 'Importance of Grouping in Adobe Illustrator' }
  ];

  const learningOutcomes = [
    'Learn how to Group and Align objects in Illustrator',
    'Create clean, structured designs with proper grouping',
    'Use smart alignment tools for professional layouts',
    'Maintain consistency throughout your design',
    'Master techniques for visual harmony and precision',
    'Understand the importance of grouping in complex projects'
  ];

  const handleMarkComplete = () => {
    if (isCompleted) {
      markLessonIncomplete('a6');
    } else {
      markLessonComplete('a6');
    }
  };
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              <div className="relative">
                <div className="aspect-video bg-black">
                  <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/oFndjEbUy0s?si=ZWJsJQtEYS68pAoa" 
                    title="Grouping & Alignment in Adobe Illustrator | Arrange & Align Objects Like a Pro – Cre8tiverse" 
                    frameBorder="0" 
              ...
              <div className="p-6 border-b border-gray-200">
                <CourseNavigation currentLessonId="a6" />
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  <div className="mb-4 md:mb-0">
                    <h1 className="text-2xl md:text-3xl font-bold text-primary mb-2">
                      Grouping & Alignment in Adobe Illustrator | Arrange & Align Objects Like a Pro
                    </h1>
                    <p className="text-lg text-gray-600">
                      Master professional alignment and grouping techniques for clean designs.
                    </p>
                  </div>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed">
                  In this video, you'll learn how to Group and Align objects in Illustrator for clean, structured designs. 
                  Discover how to arrange elements using smart alignment tools and maintain consistency throughout your layout. 
                  These techniques are essential for any designer aiming for professional precision and visual harmony.
                </p>
              </div>
            </motion.div>
          ...
          {/* Sidebar Navigation */}
          <CourseNavigation currentLessonId="a6" className="lg:col-span-1" />
        </div>
      </div>
    </div>
  );
