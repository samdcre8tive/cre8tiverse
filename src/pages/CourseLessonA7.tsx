...
const CourseLessonA7 = () => {
  ...
  const timecodes = [
    ...
    { time: '6:02', title: 'How to Draw a Triangle in Adobe Illustrator' },
    { time: '9:33', title: 'Refining Your Drawing When Wrongly Drawn with the Pen Tool' },
    { time: '12:28', title: 'Send to Back in Adobe Illustrator' },
    { time: '17:45', title: 'How to Use the Reflect Tool in Adobe Illustrator' },
    { time: '20:56', title: 'Converting a Rectangle to a Semi-Circle' },
    { time: '22:34', title: 'How to Save a File and Export in Adobe Illustrator' }
  ];

  const learningOutcomes = [
    'Create character illustrations using basic shapes',
    'Master the triangle drawing technique in Illustrator',
    'Use the Reflect Tool for symmetrical designs',
    'Apply layering techniques with Send to Back',
    'Convert shapes for creative character elements',
    'Save and export character designs properly'
  ];
  ...
  const breadcrumbItems = [
    ...
    { label: 'Creating Character Puppet' }
  ];
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              <div className="relative">
                <div className="aspect-video bg-black">
                  <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/Ojd8TQLOSck?si=7vZzXPZl47Ad35Fd" 
                    title="Creating Our First Character Puppet in Illustrator Using Basic Shapes | Cre8tiverse" 
                    frameBorder="0" 
              ...
              <div className="p-6 border-b border-gray-200">
                <CourseNavigation currentLessonId="a7" />
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  <div className="mb-4 md:mb-0">
                    <h1 className="text-2xl md:text-3xl font-bold text-primary mb-2">
                      Creating Our First Character Puppet in Illustrator Using Basic Shapes
                    </h1>
                    <p className="text-lg text-gray-600">
                      Learn character illustration using simple vector techniques and basic shapes.
                    </p>
                  </div>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed">
                  In this video, we'll create our first character puppet using basic shape tools like circles, rectangles, 
                  polygons, and squares. This is where your creativity meets structure — a practical step into character 
                  illustration using simple vector techniques. Perfect for beginners and aspiring illustrators ready to 
                  turn ideas into visual characters with precision!
                </p>
              </div>
            </motion.div>
          ...
          {/* Sidebar Navigation */}
          <CourseNavigation currentLessonId="a7" className="lg:col-span-1" />
        </div>
      </div>
    </div>
  );
