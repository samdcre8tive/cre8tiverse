...
const CourseLessonA9 = () => {
  ...
  const timecodes = [
    ...
    { time: '0:25', title: 'What Are Templates in Illustrator' },
    { time: '2:59', title: 'Must-Know Keyboard Shortcuts in Illustrator' }
  ];

  const learningOutcomes = [
    'Understand and use Templates in Adobe Illustrator',
    'Jump-start design projects with structured templates',
    'Master essential keyboard shortcuts for efficiency',
    'Dramatically improve workflow speed and productivity',
    'Streamline your design process like a professional',
    'Work faster with time-saving shortcuts and techniques'
  ];
  ...
  const breadcrumbItems = [
    ...
    { label: 'Templates & Keyboard Shortcuts' }
  ];
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              <div className="relative">
                <div className="aspect-video bg-black">
                  <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/KooH5HPbWnw?si=8ANfvTKHNwmMduGR" 
                    title="Using Templates & Must-Know Keyboard Shortcuts in Adobe Illustrator | Cre8tiverse" 
                    frameBorder="0" 
              ...
              <div className="p-6 border-b border-gray-200">
                <CourseNavigation currentLessonId="a9" />
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  <div className="mb-4 md:mb-0">
                    <h1 className="text-2xl md:text-3xl font-bold text-primary mb-2">
                      Using Templates & Must-Know Keyboard Shortcuts in Adobe Illustrator
                    </h1>
                    <p className="text-lg text-gray-600">
                      Boost productivity with templates and essential keyboard shortcuts.
                    </p>
                  </div>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed">
                  In this lesson, we dive into Templates in Adobe Illustrator — a powerful way to jump-start your design 
                  process with structure. You'll also discover essential keyboard shortcuts that will dramatically improve 
                  your speed and workflow in Illustrator. Master these tips to streamline your design journey and boost 
          ...
          {/* Sidebar Navigation */}
          <CourseNavigation currentLessonId="a9" className="lg:col-span-1" />
        </div>
      </div>
    </div>
  );
