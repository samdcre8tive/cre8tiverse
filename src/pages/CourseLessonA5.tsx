...
const CourseLessonA5 = () => {
  ...
  const isCompleted = isLessonCompleted('a5');
  ...
  const timecodes = [
    ...
    { time: '0:37', title: 'Introduction to Layers Panel in Adobe Illustrator' },
    { time: '3:05', title: 'Recognising the Active Layer' },
    { time: '8:47', title: 'Creating New Layers' },
    { time: '9:25', title: 'How to Create Sublayers' }
  ];

  const learningOutcomes = [
    'Master the fundamentals of Layers and Grouping in Illustrator',
    'Learn to organise your artwork effectively',
    'Group objects for better project management',
    'Use layer locking and visibility controls',
    'Manage complex designs with proper layer structure',
    'Create and organize sublayers for advanced workflows'
  ];

  const handleMarkComplete = () => {
    if (isCompleted) {
      markLessonIncomplete('a5');
    } else {
      markLessonComplete('a5');
    }
  };
  ...
  const breadcrumbItems = [
    ...
    { label: 'Mastering Layers & Grouping' }
  ];
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              <div className="relative">
                <div className="aspect-video bg-black">
                  <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/cNCXdINxZZw?si=-QLqN27u4dFKQFcg" 
                    title="Mastering Layers & Grouping in Adobe Illustrator | Hide, Lock & Organise Layers – Cre8tiverse" 
                    frameBorder="0" 
              ...
              <div className="p-6 border-b border-gray-200">
                <CourseNavigation currentLessonId="a5" />
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  <div className="mb-4 md:mb-0">
                    <h1 className="text-2xl md:text-3xl font-bold text-primary mb-2">
                      Mastering Layers & Grouping in Adobe Illustrator | Hide, Lock & Organise Layers
                    </h1>
                    <p className="text-lg text-gray-600">
                      Learn essential layer management for clean, professional vector design.
                    </p>
                  </div>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed">
                  In this video, you'll learn the fundamentals of Layers and Grouping in Illustrator — how to organise your artwork, 
                  group objects, and effectively use layer locking and visibility to manage complex designs. These tools are essential 
                  for clean, professional vector design. Stay creative and structured!
                </p>
              </div>
            </motion.div>
          ...
          {/* Sidebar Navigation */}
          <CourseNavigation currentLessonId="a5" className="lg:col-span-1" />
        </div>
      </div>
    </div>
  );
