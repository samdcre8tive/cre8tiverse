...
const CourseLessonA11 = () => {
  ...
  const timecodes = [
    ...
    { time: '0:32', title: 'What is Pinterest? - Getting Design Inspiration (pinterest.com)' },
    { time: '2:30', title: 'What is Behance? - Showcasing Your Work or Building Your Portfolio (behance.com)' }
  ];

  const learningOutcomes = [
    'Discover where to get design inspiration as a graphic designer',
    'Learn how to use Pinterest for creative inspiration',
    'Understand how to build a strong portfolio on Behance',
    'Develop your own unique design style',
    'Create a portfolio that stands out in the design industry',
    'Connect with the global design community'
  ];
  ...
  const breadcrumbItems = [
    ...
    { label: 'Design Inspiration & Portfolio' }
  ];
    ...
    <div className="pt-16 min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              <div className="relative">
                <div className="aspect-video bg-black">
                  <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/8K0pQrJiGl8?si=DAFpKm8xBP73eZNA" 
                    title="Where to Get Design Inspiration & Build Your Portfolio as a Graphic Designer | Cre8tiverse" 
                    frameBorder="0" 
              ...
              <div className="p-6 border-b border-gray-200">
                <CourseNavigation currentLessonId="a11" />
              </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                  <div className="mb-4 md:mb-0">
                    <h1 className="text-2xl md:text-3xl font-bold text-primary mb-2">
                      Where to Get Design Inspiration & Build Your Portfolio as a Graphic Designer
                    </h1>
                    <p className="text-lg text-gray-600">
                      Discover inspiration sources and learn to build a standout design portfolio.
                    </p>
                  </div>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed">
                  In this video, we'll explore where to get design inspiration as a graphic designer and how to build a 
                  strong portfolio. You'll discover how platforms like Behance and Pinterest can help spark your creativity 
                  and guide you in creating a portfolio that stands out in the design industry. If you're looking to develop 
                  your own style and showcase your work effectively, this video will provide essential tips for success!
                </p>
              </div>
            </motion.div>
          ...
          {/* Sidebar Navigation */}
          <CourseNavigation currentLessonId="a11" className="lg:col-span-1" />
        </div>
      </div>
    </div>
  );
...
export default CourseLessonA11;